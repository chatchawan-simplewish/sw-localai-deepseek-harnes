...
4. Live acceptance of the fixed launcher/relay source and a bound receipt schema under the systemd controls, including real Linux descriptor transfer and namespace/cgroup cleanup.
