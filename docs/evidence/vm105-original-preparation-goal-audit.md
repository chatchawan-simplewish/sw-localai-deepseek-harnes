...
Verdict: original specification completion is **NOT PROVEN**. The corrected candidate is accepted under the later conditional contract; that is not unchanged acceptance of the original specification.
