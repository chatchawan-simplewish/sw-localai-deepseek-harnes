"""Dormant, source-only prerequisites for the VM105 reconstruction."""
...
DELIVERY_ATTEMPT_PATH = REPOSITORY_ROOT / "docs/evidence/vm105-dsh-reconstruction-bundle-delivery-successor-attempt-20260914.json"
DELIVERY_TERMINAL_PATH = REPOSITORY_ROOT / "docs/evidence/vm105-dsh-reconstruction-bundle-delivery-successor-20260914.json"
BUNDLE_RECEIPT_PATH = REPOSITORY_ROOT / "docs/evidence/vm105-dsh-reconstruction-bundle-successor-20260914.json"
SUDO_RECEIPT_PATH = REPOSITORY_ROOT / "docs/evidence/vm105-dsh-reconstruction-sudo-policy-successor-20260914.json"
DISPATCH_ATTEMPT_PATH = REPOSITORY_ROOT / "docs/evidence/vm105-dsh-reconstruction-successor-attempt-20260914.json"
DISPATCH_TERMINAL_PATH = REPOSITORY_ROOT / "docs/evidence/vm105-dsh-reconstruction-successor-20260914.json"
...
# Deliberately dormant. A later reviewed source change must bind each exact hash.
...
def deliver_bundle(authority_sha256, transport, *, read_source, lstat=os.lstat,
    ...
    _require_absent((DELIVERY_ATTEMPT_PATH, DELIVERY_TERMINAL_PATH), lstat)
    files = []
    for row in BUNDLE_FILES:
